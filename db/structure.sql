...
CREATE TABLE public.geolocations (
    id bigint NOT NULL,
    coordinates public.geography(Geometry,4326),
...
--
-- Name: index_geolocations_on_ip; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_geolocations_on_ip ON public.geolocations USING btree (ip) WHERE (url IS NULL);


--
-- Name: index_geolocations_on_ip_and_url; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_geolocations_on_ip_and_url ON public.geolocations USING btree (ip, url) WHERE (url IS NOT NULL);
